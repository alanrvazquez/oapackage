...
<<<<<<< HEAD
The even-odd arrays are a special class of orthognal arrays with at least one of the odd :math:`J`-characteristics larger than zero.
=======
...
<<<<<<< HEAD
A Python script to generate optimal designs with 40 runs
