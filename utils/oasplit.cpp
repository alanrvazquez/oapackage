/** \file oasplit.cpp
 ...
 oasplit can split a file with arrays into multiple files. This is usefull when the total number of arrays exceeds the
 memory
...
int main (int argc, char *argv[]) {
        ...
        if (nmax > 1000) {
                logstream (NORMAL) << printfstring (
                    "oasplit: warning nsplit might be larger then max number of file descriptors available...\n");
        }
